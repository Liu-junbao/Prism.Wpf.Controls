...
namespace Lb.CustomControls
{
    ...
    public class TransitionBox : ContentControl
    {
        ...
        {
            TransitionBox source = (TransitionBox)d;
        ...
        {
            ((TransitionBox)d).OnRestartTransitionOnContentChangeChanged((bool)e.OldValue, (bool)e.NewValue);
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransitionBox"/> class.
        /// </summary>
    ...
    public static class VisualTreeHelperEx
    {
        ...
        public static TElement FindParent<TElement>(this DependencyObject dependencyObject)
            where TElement : DependencyObject
        {
            var parent = VisualTreeHelper.GetParent(dependencyObject);
            if (parent == null) parent = LogicalTreeHelper.GetParent(dependencyObject);
            if (parent != null)
            {
                var parentElement = parent as TElement;
                if (parentElement == null) return parent.FindParent<TElement>();
