...
namespace Lb.CustomControls.Charts
{
    ...
    {
        public static readonly DependencyProperty XLabelTemplateProperty =
            DependencyProperty.Register(nameof(XLabelTemplate), typeof(DataTemplate), typeof(Chart), new PropertyMetadata(null));
        public static readonly DependencyProperty YLabelTemplateProperty =
            DependencyProperty.Register(nameof(YLabelTemplate), typeof(DataTemplate), typeof(Chart), new PropertyMetadata(null));
        ...
        public DataTemplate XLabelTemplate
        {
            get { return (DataTemplate)GetValue(XLabelTemplateProperty); }
            set { SetValue(XLabelTemplateProperty, value); }
        }

        public DataTemplate YLabelTemplate
        {
            get { return (DataTemplate)GetValue(YLabelTemplateProperty); }
            set { SetValue(YLabelTemplateProperty, value); }
        }
